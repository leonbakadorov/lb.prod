...
<div class="swiper-container">
    ...
    <div class="swiper-wrapper">
        ...
        $folder = '/img/site-kareliadsp';
        $slides = [
            [
                'desc' => 'Главная страница веб-сайта',
                'img' => '1'
            ],
            [
                'desc' => 'Страница «О компании»',
                'img' => '2'
            ],
            [
                'desc' => 'Иллюстрирование упаковки для транспортировки',
                'img' => '3'
            ],
            [
                'desc' => 'Обзор форматов и&nbsp;толщин продукции',
                'img' => '4'
            ]
