...
<div class="swiper-container">
    ...
    <div class="swiper-wrapper">
        ...
        $folder = '/img/profile-friendwork';
        $slides = [
            [
                'desc' => 'Обзор профиля кандидата',
                'img' => '1'
            ],
            [
                'desc' => 'Заполнение формы оценки',
                'img' => '2'
            ],
            [
                'desc' => 'Просмотр новостей о кандидате',
                'img' => '3'
            ],
            [
                'desc' => 'Поиск аккаунтов кандидата в соц. сетях',
                'img' => '4'
            ]
