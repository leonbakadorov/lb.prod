...
<div class="swiper-container">
    ...
    <div class="swiper-wrapper">
        ...
        $folder = '/img/candidates-friendwork';
        $slides = [
            [
                'desc' => 'Список кандидатов, вид "карточка"',
                'img' => '1'
            ],
            [
                'desc' => 'Настройка сортировки кандидатов',
                'img' => '2'
            ],
            [
                'desc' => 'Табличный вид списка кандидатов',
                'img' => '3'
            ],
            [
                'desc' => 'Панель фильтров',
                'img' => '4'
            ]
